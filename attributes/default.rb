...
default['dynamic-dynamodb']['config']['global']['aws_access_key_id'] = 'AKIAJPAUWLTXPV3RZ2GQ'
default['dynamic-dynamodb']['config']['global']['aws_secret_access_key_id'] = 'nESr+WcuSXdfJF2i4lMvl0rMNte9+oDxapsSIxuR'
